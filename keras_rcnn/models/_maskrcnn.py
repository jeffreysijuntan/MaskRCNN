...
class MaskRCNN(keras.models.Model):
    ...
    def __init__(
        ...
        output_roi_features = keras_rcnn.layers.RegionOfInterest((14,14))([
            target_metadata,
            output_features,
            output_proposal_bounding_boxes
        ])
        ...
        output_masks = keras_rcnn.layers.RCNNMaskLoss()([target_bounding_boxes, output_proposal_bounding_boxes, target_masks, output_masks])
